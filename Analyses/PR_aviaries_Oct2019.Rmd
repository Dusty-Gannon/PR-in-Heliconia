---
title: "Appendix S3: Pollinator recognition as a mechanism of cryptic pollinator specialization by *Heliconia* - Aviary experiments"
...
```{r data}
  ...
  av <- read.csv("~/Documents/Heliconia/Data/PR/aviaries_data.csv", header = T, as.is = T)
...
#  scale measure of hours after midnight
  av$hrs_postmidn <- scale(as.integer(hours(av$HP_time)) + as.numeric(minutes(av$HP_time))/60)
